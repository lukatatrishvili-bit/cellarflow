...
import type {
  ...
  InventoryItem, LabAnalysis, CellarTransferRecord, GrapeIntakeRecord, CellarOperation,
...
export const demoBlocks: VineyardBlock[] = [
  {
    ...
    cadastralCode: '53.00.00.001', municipality: 'თელავი', community: 'წინანდლის თემი', village: 'ქონდოლი', parcelName: 'ნაკვეთი №1',
  ...
  },
  {
    ...
    cadastralCode: '51.00.00.003', municipality: 'გურჯაანი', community: 'მუკუზნის თემი', village: 'მუკუზანი', parcelName: 'ტერასა S-3',
...
export const demoHarvests: HarvestRecord[] = [
  {
    ...
    estimatedTons: 14, actualHarvestDate: '2026-09-23', actualHarvestedKg: 13800, harvestedAreaHa: 2.4, pickingMethod: 'hand',
  ...
  },
  {
    ...
    estimatedTons: 7, actualHarvestDate: '2026-09-29', actualHarvestedKg: 7200, harvestedAreaHa: 1.1, pickingMethod: 'hand',
...
export const demoLots: WineLot[] = [
  {
    ...
    region: 'კახეთი', initialVolume: 9800, currentVolume: 9400, wineClass: 'red', sugarCategory: 'dry', stage: 'aging', createdAt: '2026-10-02',
    history: [
  ...
  },
  {
    ...
    region: 'კახეთი', initialVolume: 5100, currentVolume: 5000, wineClass: 'amber', sugarCategory: 'dry', stage: 'aging', createdAt: '2026-10-05',
  ...
  },
  {
    ...
    region: 'კახეთი', initialVolume: 6000, currentVolume: 1200, wineClass: 'red', sugarCategory: 'dry', stage: 'bottled', createdAt: '2025-10-10',
...
export const demoTransfers: CellarTransferRecord[] = [
  { id: 'TR-1', date: '2026-10-02', sourceId: 'ქვევრი Q-1', destId: 'ცისტერნა T-1', volume: 1350, loss: 8, category: 'transfer', details: 'ქვევრიდან გადატანა', pump: 'Liverani', operator: 'ლუკა', sourceLotId: 'SAP-2026-01', resultLotId: 'SAP-2026-01', sourceContributionL: 1350, arrivalVolumeL: 1342 },
  { id: 'TR-2', date: '2026-10-18', sourceId: 'ცისტერნა T-1', destId: 'ცისტერნა T-2', volume: 400, loss: 3, category: 'blend', details: 'კუპაჟის მომზადება', pump: 'Liverani', operator: 'ლუკა', sourceLotId: 'SAP-2026-01', destinationLotId: 'RKA-2026-01', resultLotId: 'RKA-2026-01', sourceContributionL: 400, destinationContributionL: 5000, arrivalVolumeL: 397 },
];
...
export const demoGrapeIntakes: GrapeIntakeRecord[] = [
  {
    ...
    cadastralCode: '53.00.00.001', municipality: 'თელავი', community: 'წინანდლის თემი', village: 'ქონდოლი', harvestedAreaHa: 2.4,
  ...
  },
  {
    ...
    cadastralCode: '51.00.00.003', municipality: 'გურჯაანი', community: 'მუკუზნის თემი', village: 'მუკუზანი', harvestedAreaHa: 1.1,
