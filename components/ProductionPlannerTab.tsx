...
export default function ProductionPlannerTab(props: ProductionPlannerTabProps) {
  ...
  const addPlan = () => {
    ...
    setTitle(''); setLotId(''); setVesselIds([]); setBlockId(''); setQuantityLiters(''); setNotes(''); setShowCreate(false);
  };
