        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[8px] px-2 py-0.5 font-mono font-black bg-stone-100/90 text-[#4e0e15] border border-[#e8dfd5] rounded-sm uppercase tracking-widest flex items-center gap-1 dark:bg-stone-900 dark:text-amber-400 dark:border-stone-850">
